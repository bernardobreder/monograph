...
void* b_hashnew_put(b_hashnew_t* self, const char* key, int hash, int size,
		void* value);
...
void* b_hashclose_get1(b_hashclose_t* self, b_chars_t* key);

void* b_hashclose_put1(b_hashclose_t* self, b_chars_t* key, void* value);
