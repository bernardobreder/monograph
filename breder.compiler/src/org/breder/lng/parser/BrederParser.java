 ...
 * 
 */
public class BrederParser extends AbstractParser {
	 ...
	 * @param lexer
	 */
	public BrederParser(AbstractLexer lexer) {
		super(lexer);
	}
	...
	public CommandNode readCommand() throws IOException, ParserException {
		...
		case BrederWordToken.IF:
			return this.readIf();
		case BrederWordToken.FOR:
			return this.readFor();
		case BrederWordToken.WHILE:
			return this.readWhile();
		case BrederWordToken.REPEAT:
			return this.readRepeat();
		case BrederWordToken.DO:
	...
	public CommandNode readIf() throws IOException, ParserException {
		if (!this.match(BrederWordToken.IF)) {
	...
	public CommandNode readFor() throws IOException, ParserException {
		if (!this.match(BrederWordToken.FOR)) {
	...
	public CommandNode readWhile() throws IOException, ParserException {
		if (!this.match(BrederWordToken.WHILE)) {
	...
	public CommandNode readRepeat() throws IOException, ParserException {
		if (!this.match(BrederWordToken.REPEAT)) {
	...
	public ValueNode readOr() throws IOException, ParserException {
		...
		while (this.match(BrederWordToken.OR)) {
			this.next();
	...
	public ValueNode readAnd() throws IOException, ParserException {
		...
		while (this.match(BrederWordToken.AND)) {
			this.next();
	...
	public ValueNode readLiteral() throws IOException, ParserException {
		switch (this.lookTag()) {
		case BrederWordToken.NUM:
			return this.readNumber();
		case BrederWordToken.STR:
			return this.readString();
		case BrederWordToken.TRUE:
			return this.readTrue();
		case BrederWordToken.FALSE:
			return this.readFalse();
		case BrederWordToken.THIS:
		case BrederWordToken.ID:
