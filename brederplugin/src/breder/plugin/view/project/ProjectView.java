package breder.plugin.view.project;
...
public class ProjectView extends ViewPart {
	...
	public static final String ID = "brederplugin.view.project.ProjectView";
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setInput(BRootBinary.getInstance());
	}
	...
	private void makeActions() {
		action1 = new Action() {
			public void run() {
				Object object = BActivator.getDefault().getBundle().getEntry(
						"/icons/");
