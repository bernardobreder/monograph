...
typedef int __int24_t;
typedef int __int32_t;
typedef unsigned char b_byte_t;
typedef unsigned int __uint32_t;
typedef __int32_t __inst ;

typedef struct b_array_t b_array_t;
typedef void* b_structs_t;
typedef struct b_linker_t b_linker_t;
typedef struct b_linker_node_t b_linker_node_t;

typedef struct b_inst_t b_inst_t;
typedef __int24_t b_inst_id_t;
typedef __int24_t b_stack_id_t;
...
typedef __int16_t b_class_id_t;
typedef __int16_t b_method_id_t;
typedef __int16_t b_field_id_t;

#ifdef DEBUG_APP
typedef struct b_debug_t b_debug_t;
#endif
...
typedef struct b_array_t b_array_number_t;
...
typedef unsigned char b_boolean_t;
typedef double b_number_t;
#define B_NUMBER_SCANF "%lf"
#define B_INTEGER_SCANF "%d"
// #define B_NUMBER_SCANF "%lf"
typedef long b_integer_t;
